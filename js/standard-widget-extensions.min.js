...
2!=b.mode&&(a.o.css("position","relative"),a.o.css("top","0"),a.o.css("left","0"),a.o.css("width",""),a.o.css("margin-left",""),a.fixed=0);a.previoustop=d}},h=function(a){var f=c(n);b.content_top=f.offset().top;b.content_margin_top=parseInt(f.css("margin-top"),10);b.content_top-=b.content_margin_top;b.content_height=f.outerHeight(!0);b.window_height=c(g).height();b.prevscrolltop=-1;b.direction=0;d.o&&u(d);e.o&&u(e);d.o&&(0!=d.mode&&e.o&&0!=e.mode)&&(b.content_height=Math.max(b.content_height,d.height+
d.default_offset.top-b.content_top,e.height+e.default_offset.top-b.content_top));d.o&&v(d);e.o&&v(e);t();!0===a&&(0<swe.recalc_after&&0<swe.recalc_count)&&(1E4>swe.recalc_count&&swe.recalc_count--,setTimeout(h,1E3*swe.recalc_after,!0))},w=function(a){var b=a.o.css("float");return c(g).width()>=a.disable_iflt&&(!a.float_attr_check_mode||"left"==b||"right"==b)},u=function(a){a.height=a.o.outerHeight(!0);a.fixed=0;a.previoustop=0;a.o.css("position","relative");a.o.css("top","0");a.o.css("left","0");
a.o.css("width","");a.width=parseFloat(a.o.css("width"));a.o.css("margin-left","");a.margin_left=parseFloat(a.o.css("margin-left"),10);a.default_offset=a.o.offset();if(a.default_offset){a.default_offset.top-=a.margin_top;a.default_offset.left-=a.margin_left;var b=a.o.offsetParent();a.absolute_adjustment_top=b.offset().top;a.absolute_adjustment_left=b.offset().left;w(a)?a.mode=1:a.mode=0}},v=function(a){a.default_offset.top+a.height>=b.content_top+b.content_height||!w(a)?a.mode=0:a.mode=a.height+b.header_space<=
b.window_height?2:1};swe.resizeHandler=h;c(g).scroll(t);c(g).resize(h);swe.recalc_after=parseInt(swe.recalc_after,10);swe.recalc_count=parseInt(swe.recalc_count,10);h(!0)}swe.reloadHandler=function(){swe.accordion_widget&&r();swe.scroll_stop&&c(n).length&&(l(d,swe.sidebar_id,swe.proportional_sidebar,swe.disable_iflt,swe.float_attr_check_mode),l(e,swe.sidebar_id2,swe.proportional_sidebar2,swe.disable_iflt2,swe.float_attr_check_mode2),swe.resizeHandler())};var k;for(k=0;k<swe.tab_sidebar_id.length;k++)if(swe.tab_sidebar_id[k]){var x=
c("#"+swe.tab_sidebar_id[k]);x.length&&x.tabs()}})})(jQuery,window,document);
