...
d.default_offset.top-b.content_top,e.height+e.default_offset.top-b.content_top));d.o&&u(d);e.o&&u(e);s();!0===a&&(0<swe.recalc_after&&0<swe.recalc_count)&&(9999!=swe.recalc_count&&swe.recalc_count--,setTimeout(h,1E3*swe.recalc_after,!0))},v=function(a){var b=a.o.css("float");return c(g).width()>=a.disable_iflt&&(!a.float_attr_check_mode||"left"==b||"right"==b)},t=function(a){a.height=a.o.outerHeight(!0);a.fixed=0;a.previoustop=0;a.o.css("position","relative");a.o.css("top","0");a.o.css("left","0");
